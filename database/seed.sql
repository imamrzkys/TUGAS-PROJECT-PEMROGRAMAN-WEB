...
-- SEED PROFILES (Users)
-- ============================================================
INSERT INTO profiles (nim, email, password_hash, nama_lengkap, role, jurusan, program_studi, angkatan, semester_aktif, telepon, alamat) VALUES
-- Admin
...
-- Semester 4
('TIF401', 'Mobile Programming', 3, 4, 'pilihan', 'Pemrograman aplikasi mobile'),
('TIF402', 'Machine Learning', 3, 4, 'pilihan', 'Konsep dan implementasi ML'),
('TIF403', 'Keamanan Sistem Informasi', 3, 4, 'pilihan', 'Security dan kriptografi');
...
-- SEED PENGUMUMAN
-- ============================================================
INSERT INTO pengumuman (judul, konten, kategori, author_id) VALUES
...
-- SEED PEMBAYARAN
-- ============================================================
INSERT INTO pembayaran (mahasiswa_id, jenis, semester, tahun_ajaran, jumlah, status, deadline, va_number) VALUES
...
(7, 'UKT', 'ganjil', '2023/2024', 5000000, 'pending', '2023-08-31', 'VA001234567892'),
(5, 'UKT', 'genap', '2023/2024', 5000000, 'pending', '2024-02-28', 'VA001234567893');

-- ============================================================
-- SEED TUGAS
-- ============================================================
INSERT INTO tugas (kelas_id, judul, deskripsi, deadline, bobot_nilai, is_published) VALUES
...
-- SEED MATERI
-- ============================================================
INSERT INTO materi (kelas_id, judul, deskripsi, pertemuan_ke, is_published) VALUES
(4, 'Pengenalan HTML', 'Materi pengenalan HTML dan struktur dasar dokumen web', 1, 1),
(4, 'CSS Styling', 'Materi tentang styling dengan CSS', 2, 1),
(4, 'JavaScript Fundamentals', 'Materi dasar-dasar JavaScript', 3, 1),
(5, 'Model OSI dan TCP/IP', 'Materi tentang model referensi jaringan', 1, 1),
(5, 'IP Addressing', 'Materi tentang pengalamatan IP', 2, 1);

-- ============================================================
-- SIAKAD Kampus - Skema Database (Versi Bahasa Indonesia)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS profil (
  ...
  peran ENUM('mahasiswa', 'dosen', 'admin') NOT NULL DEFAULT 'mahasiswa',
  jurusan VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS kelas (
  ...
  FOREIGN KEY (dosen_id) REFERENCES profil(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS krs (
  ...
  FOREIGN KEY (mahasiswa_id) REFERENCES profil(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS materi (
  ...
  ukuran_file_mb DECIMAL(6,2),
  pertemuan_ke INT,
  dipublikasi TINYINT(1) DEFAULT 1,
  dibuat_pada TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (kelas_id) REFERENCES kelas(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS tugas (
  ...
  dipublikasi TINYINT(1) DEFAULT 0,
  dibuat_pada TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  diperbarui_pada TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (kelas_id) REFERENCES kelas(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS pengumuman (
  ...
  pembuat_id INT,
  dibuat_pada TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (pembuat_id) REFERENCES profil(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS pembayaran (
  ...
  status ENUM('menunggu', 'lunas', 'kadaluarsa', 'verifikasi') DEFAULT 'menunggu',
  batas_waktu DATE,
  nomor_va VARCHAR(30),
